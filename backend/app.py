...
#     features = create_features(price_history)
#     if features is None:
#         return {"price": price, "prediction": "WAITING"}
...
# app.add_middleware(
#     CORSMiddleware,
#     allow_origins=["*"],  # Tüm kaynaklardan gelen istekleri kabul et
#     allow_credentials=True,
#     allow_methods=["*"],  # Tüm HTTP metotlarını kabul et
...
#         return {"error": "No price history yet"}

#     plt.figure(figsize=(10, 5))
#     plt.plot(price_history, label='BTC Price (USD)')
...
#     # Grafik belleğe kaydediliyor
#     buf = io.BytesIO()
#     plt.savefig(buf, format="png")
#     buf.seek(0)  # Başından başlatıyoruz
#     plt.close()

#     # Görseli stream olarak döndürüyoruz
#     return StreamingResponse(buf, media_type="image/png")
@app.get("/chart")
def chart():
